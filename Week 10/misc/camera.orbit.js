function OrbitCamera (input) {
	...
	this.getViewMatrix = function() {
		...
		//let viewMatrix = this.cameraWorldMatrix.clone();
		let viewMatrix = this.cameraWorldMatrix.clone().inverse();
		let t = new Matrix4();
		//viewMatrix.multiply(t.makeTranslation([0, 0, -this.minDistance * this.zoomScale]) );
		//viewMatrix.multiply(t.makeRotationY(this.yawDegrees));
		//viewMatrix.multiply(t.makeRotationX(this.pitchDegrees));
		return viewMatrix;
	}
