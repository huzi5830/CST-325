...
function createScene() {
    ...
    groundGeometry.worldMatrix.multiply(t.makeScale(50,2,50)).multiply(t.makeTranslation(0,-1,0)).multiply(t.makeRotationX(90));
    
    // todo #3 - create the sphere geometry
     sphereGeometry = new WebGLGeometryJSON(gl);
     console.log(loadedAssets.sphereJSON);
     sphereGeometry.create(loadedAssets.sphereJSON);
   

    // todo #4 - scale and translate the sphere
    sphereGeometry.worldMatrix.makeTranslation(0,0,-2)
    sphereGeometry.worldMatrix.multiply(t.makeScale(0.01,0.01,0.01));
    sphereGeometry.worldMatrix.multiply(t.makeTranslation(0,0,-5));
...
function updateAndRender() {
    ...
    sphereGeometry.gl.uniform4f(colorProgram.uniforms.colorUniform, 1.0, 1.0, 1.0, 1.0);
